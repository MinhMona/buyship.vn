                                                    ...
                                                    <div class="table table-info   ">
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>Đơn hàng đã có tại kho JP</td>
                                                                    <td><span
                                                                        class="teal-text text-darken-4 font-weight-700">
                                                    ...
                                                    <div class="table table-info   ">
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>Tổng tiền hàng chờ về kho JP</td>
                                                                    <td><span
                                                                        class="teal-text text-darken-4 font-weight-700">
                                                                ...
                                                                <tr>
                                                                    <td>Tổng tiền hàng đã về kho JP</td>
                                                                    <td><span
                                                                        class="teal-text text-darken-4 font-weight-700">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="input-field col s12 l6">
                                                                <asp:DropDownList runat="server" ID="ddlStatus">
                                                                    ...
                                                                    <asp:ListItem Value="6" Text="Đã về kho JP"></asp:ListItem>
