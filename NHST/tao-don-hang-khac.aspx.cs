    ...
    public partial class tao_don_hang_khac1 : System.Web.UI.Page
    {
        ...
        {           
            ...
            if (obj_user != null)
            {
                ...
                double TotalPriceVND_DatCoc = (priceCYN * currency) ;
                string AmountDeposit = (TotalPriceVND_DatCoc * LessDeposit / 100).ToString();
                ...
                string kq = MainOrderController.Insert(UID, "", "", "", false, "0", false, "0", false, "0",
                            ...
                            "0", "", fullname, address, email, phone, 0, Deposit, currency.ToString(), TotalPriceVND.ToString(),
                            salerID, dathangID, currentDate, UIDCreate, AmountDeposit, 3, FeeBuyProUser);
                ...
                if (idkq > 0)
                {
                    ...
                    for (int i = 0; i < products.Length - 1; i++)
                    {
                        ...
                        {
                            imagein = FileUploadCheck.ConvertBase64ToImageCustom(productimage, stt);                          
                        }
                        stt++;

                        string ret = OrderController.Insert(UID, productname, productname, CNYPrice.ToString(),
                        promotionprice.ToString(), productvariable, productvariable, productvariable, imagein, imagein,
                        "", "", "", "", quantity.ToString(), "", "", "", "", "", productlink, "", "", "", "", "", productnote,
                        "", "0", "Web", "", false, false, "0", false, "0", false, "0", false, "0", false, "0", e_pricevn.ToString(),
                        e_pricebuy.ToString(), productnote, fullname, address, email, phone, 0, "0", currency.ToString(), TotalPriceVND.ToString(),
                        idkq, DateTime.Now, UIDCreate);
                    }
