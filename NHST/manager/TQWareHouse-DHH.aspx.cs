        ...
        public static string GetCode(string barcode)
        {
            ...
            if (HttpContext.Current.Session["userLoginSystem"] != null)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        var packages = SmallPackageController.GetListOrderTransactionCodeKhoTQ(barcode.Trim());
                        if (packages.Count > 0)
                        {
                                ...
                                if (mainorder != null)
                                {
                                    ...
                                    if (smallpackages.Count > 0)
                                    {
                                        ...
                                        if (isChuaVekhoTQ == false)
                                        {
                                            ...
                                            //                             "Thông báo tại BUYSHIP.", "Hàng của đơn hàng " + MainorderID + " đã về kho TQ.", "");
                                            //                     }
                                            //                     catch { }
                                            //                 }
                                            //             }
         ...
         double dai, double rong, double cao, string nvkiemdem, string khachghichu, string loaisanpham, string base64, string description)
        {
            ...
            if (package != null)
            {
                ...
                else
                {
                    ...
                    SmallPackageController.UpdateIMG(package.ID, link, currentDate, username_current);
