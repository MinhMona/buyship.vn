<%@ Page Title="Danh sách đơn hàng về muộn" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="OrderLateList.aspx.cs" Inherits="NHST.manager.OrderLateList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col s12 page-title">
                <div class="card-panel">
                    <div class="title-flex">
                        <h4 class="title no-margin">Đơn hàng về muộn</h4>
                    </div>
                </div>
            </div>
 ...
 <%--   <asp:Button Style="display: none" UseSubmitBehavior="false" ID="btnSearchMVD" runat="server" OnClick="btnSearchMVD_Click" />
    ...
    <script type="text/javascript">
        <%--    function saveNote(orderID, obj) {
            var r = confirm('Bạn muốn lưu ghi chú cho đơn: ' + orderID);
            if (r == true) {
      ...
      <%--  function UpdateStaff(obj) {
        ...
        function saveNote(ID) {
            var note = $("#txtStaffNote"+ID).val();
            $.ajax({
                type: "POST",
                url: "/manager/OrderLateList.aspx/SaveNote",
                data: "{MainOrderID:'" + ID + "',Note:'" + note + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
