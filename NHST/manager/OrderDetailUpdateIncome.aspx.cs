...
{
    public partial class OrderDetailUpdateIncome : System.Web.UI.Page
    {
                    ...
                    if (id > 0)
                    {
                        ...
                        if (o != null)
                        {
                            ...
                            else
                            {
                                ...
                                var mo = MainOrderController.GetAllByID(id);
                                int SalerID = mo.SalerID.Value;
                                int DathangID = mo.DathangID.Value;
                                //int KhoTQID = mo.KhoTQID.Value;
                               // int khoVNID = mo.KhoVNID.Value;
                                if (mo != null)
                                {
                                    double feebp = Math.Round(Convert.ToDouble(mo.FeeBuyPro), 0);
                                    DateTime CreatedDate = Convert.ToDateTime(mo.CreatedDate);
