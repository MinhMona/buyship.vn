                ...
                if (user != null)
                {
                    ...
                    if (userRole == 0 || userRole == 2 || userRole == 5)
                    {
                        ...
                        if (bigpackage != null)
                        {
                            ...
                            if (smallpackages.Count > 0)
                            {
                                foreach (var item in smallpackages)
                                {
                                    ...
                                    {
                                        si.OrderType = "Đơn vận chuyển hộ";
                                        si.MainorderID = tID;
                                        ...
                                        string Phone = "";
                                        string Username = "";
                                        var orderTransportation = TransportationOrderNewController.GetByIDKhoVN(Convert.ToInt32(item.TransportationOrderID));
                        ...
                        else
                        {
                            ...
                            bi.BigpackageType = 2;
                            List<smallpackageitem> sis = new List<smallpackageitem>();
                            var smallpackages = SmallPackageController.GetListOrderTransactionCodeKhoVN(barcode);
                            if (smallpackages.Count > 0)
                            {
                                foreach (var item in smallpackages)
                                {
            ...
            string packageadditionfeeVND, string packageSensorCYN, string packageSensorVND)
        {
            ...
            if (package != null)
            {
                ...
                else
                {
                    ...
                    SmallPackageController.UpdateNote(package.ID, note);
                    SmallPackageController.UpdateDateScanKho(package.ID, currentDate);
                    ...
                    if (mainorder != null)
                    {
                        ...
                        if (smallpackage.Count > 0)
                        {
                            ...
                            if (!string.IsNullOrEmpty(usercreate.FeeTQVNPerWeight))
                            {
                                ...
                                {
                                    double perweight = Convert.ToDouble(item.Weight) * feetqvn;
                                    SmallPackageController.UpdateTotalPrice_New(item.ID, perweight.ToString(), feetqvn.ToString());
                                }
                            }
                            else
                            {
                        ...
                        if (accChangeData != null)
                        {
                            if (status == 3)
                            {
                               ...
                               " đã đổi trạng thái của mã vận đơn: <strong>" + barcode + "</strong> của đơn hàng ID là: " + mainorder.ID + ", là: Đã về kho VN", 8, currentDate);
                            }
                    ...
                    else
                    {
                        ...
                        if (transportation != null)
                        {
                            ...
                            {
                                additionfeeCYN = Math.Round(Convert.ToDouble(packageadditionfeeCYN), 0);
                            }
                            if (packageadditionfeeVND.ToFloat(0) > 0)
                            {
                                additionfeeVND = Math.Round(Convert.ToDouble(packageadditionfeeVND), 0);
                            }
                            if (packageSensorCYN.ToFloat(0) > 0)
                            {
                                sensorCYN = Math.Round(Convert.ToDouble(packageSensorCYN), 0);
                            }
                            if (packageSensorVND.ToFloat(0) > 0)
                            {
                                sensorVND = Math.Round(Convert.ToDouble(packageSensorVND), 0);
                            }
                            ...
                            TransportationOrderNewController.UpdateTotalWeightTotalPrice(tID, totalweight.ToString(), totalPriceVND.ToString(), currentDate, username_current);
