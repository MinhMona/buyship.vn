    ...
    public partial class Tariff_TQVN : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (f != null)
            {
                ...
                Convert.ToInt32(f.WarehouseID), WeightFrom, WeightTo, Amount, Convert.ToInt32(ddlShipping.SelectedValue),
                Convert.ToInt32(ddlShipping.SelectedValue), Convert.ToBoolean(f.IsHidden), Convert.ToBoolean(lbType.SelectedValue.ToInt(0)), DateTime.Now, Username);
