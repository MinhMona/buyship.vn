                        ...
                        <div class="row mt-2 pt-2">
                            <div class="input-field col s12 l2">
                                <asp:ListBox runat="server" ID="select_by">
                                    ...
                                    <asp:ListItem Value="1">Mã vận đơn</asp:ListItem>
                                    <asp:ListItem Value="2">ID mua hộ</asp:ListItem>
                                    <asp:ListItem Value="3">ID ký gửi</asp:ListItem>
                                    <asp:ListItem Value="4">ID MVĐ</asp:ListItem>
                                </asp:ListBox>
                            ...
                            <div class="input-field col s12 l4">
                                ...
                                <label class="active" for="txtSearchName"><span>Nhập mã vận đơn/mã đơn hàng</span></label>
                            </div>
                            <div class="input-field col s12 l6">
                                <asp:ListBox runat="server" SelectionMode="Multiple" class="select_all" ID="status">
                                    <asp:ListItem Value="0">Hủy</asp:ListItem>
                                    <asp:ListItem Value="1">Mới đặt - chưa về kho JP</asp:ListItem>
                                    <asp:ListItem Value="2">Đã về kho JP</asp:ListItem>
            ...
            <div class="list-staff col s12 section">
                <div class="list-table card-panel">
                    <div class="table-info row center-align-xs">
                        <span class="checkout col s12 m6">Tổng cân nặng nhập kho : <%--<span class="font-weight-700 black-text">300 kg</span>--%><asp:Literal runat="server" ID="ltrTotalWeight"></asp:Literal>
                        </span>
                    </div>
                        ...
                        <table class="table  highlight bordered   mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th style="min-width: 100px;">Cân nặng QĐ (kg)</th>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m12">
                                <select id="mvc_detail-status">
                                    ...
                                    <option value="0">Chưa nhận hàng tại JP</option>
                                    <option value="1" selected>Đã về kho JP</option>
