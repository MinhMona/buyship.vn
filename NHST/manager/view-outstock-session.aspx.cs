                ...
                if (id > 0)
                {
                    ...
                    if (os != null)
                    {
                        ...
                        if (ops.Count > 0)
                        {
                            ...
                            htmlout += "           <span class=\"company-info\" style=\"font-size: 14px;\">BUYSHIP.VN</span>";
                            htmlout += "           <span class=\"company-info\">Địa chỉ: " + address + "</span>";
                            htmlout += "           <span class=\"company-info\">Website: BUYSHIP.VN</span>";
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                ...
                if (ots != null)
                {
                    ...
                    html += "           <label class=\"row-info\">" + string.Format("{0:N0}", AccountController.GetByID(a.ID).Wallet) + " VNĐ</label>";
                    html += "       </div>";
