        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">CẤU HÌNH HỆ THỐNG BUYSHIP.VN</h4>
                            ...
                            <div id="general-sec" class="section scrollspy fee-order">
                                ...
                                <div class="child-fee">
                                    <div class="content-panel">
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Địa chỉ</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" placeholder="" type="text" ID="txtAddress1"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="value-sec" class="section scrollspy fee-order">
                                ...
                                <div class="child-fee">
                                    <div class="content-panel">
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phần trăm nhân viên sale trong 1 tháng đầu</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phần trăm nhân viên sale sau 1 tháng</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
