    ...
    public partial class danh_sach_vch : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if (os.Count > 0)
            {
                ...
                StrExport.Append("      <th><strong>Kho JP</strong></th>");
                ...
                foreach (var item in os)
                {
                    ...
                    if (ui != null)
                    {
                        var salerAccount = AccountController.GetByID(Convert.ToInt32(ui.SaleID));
                        if(salerAccount != null)
                        {
                            saler = salerAccount.Username;
                        }
