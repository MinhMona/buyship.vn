...
namespace NHST.manager
{
    public partial class ReportManagerSale : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            var la = MainOrderController.GetFromDateToDate_IncomSaler_total(fd, td, search, ac.Username, page, 20, st);
        ...
        protected void search_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("ReportManagerSale?s=" + searchname + "&st=" + st + "&fd=" + fd + "&td=" + td + "");
            }
