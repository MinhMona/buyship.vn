...
namespace NHST.manager
{
    public partial class ReportManagerDealer : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            var la = MainOrderController.GetFromDateToDate_IncomDealer_total(fd, td, search, ac.Username, page, 20, st);
            var tt = MainOrderController.GetFromDateToDate_IncomDealer_Thang_total(fd, td, search, ac.Username, st);
        ...
        protected void search_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("ReportManagerDealer?s=" + searchname + "&st=" + st + "&fd=" + fd + "&td=" + td + "");
            }
