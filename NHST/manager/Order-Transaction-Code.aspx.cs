...
namespace NHST.manager
{
    public partial class Order_Transaction_Code : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            TotalWeight = SmallPackageController.GetTotalWeight("Weight", fd, td);
            ltrTotalWeight.Text = "<span class=\"font-weight-700 black-text\">" + TotalWeight.ToString() + " Kg</span>";
        ...
        public void pagingall(List<SmallPackageController.smallpackage> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                {
                    var item = acs[i];
                    double volume = (item.Height * item.Length * item.Width) / 6000;
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                double volume = (item.Height * item.Width * item.Length) / 6000;
                StrExport.Append("  <tr>");
