    ...
    public partial class home : System.Web.UI.Page
    {
        ...
        private void LoadOrder()
        {
            ...
            if (st6 > 0)
            {
                ...
                labelRatioByPro2.Add("Đã về kho JP");
            }
        ...
        [WebMethod]
        public static string LoadNotification()
        {
            ...
            if (obj_user != null)
            {
                ...
                if (config != null)
                {
                    ...
                    /*if (ui != null)
                    {
                        ...
                        {
                            if (File.Exists(HttpContext.Current.Server.MapPath("" + ui.IMGUser + "")))
                            {
                                uImage = ui.IMGUser;
                            }
                            else
                    ...
                    //result += "<li class=\"hide-on-med-and-down\"><a class=\"waves-effect waves-block waves-light toggle-fullscreen\" href=\"javascript:void(0);\"><i class=\"material-icons\">settings_overscan</i></a></li>";
                    ...
                    //result += "<li><a class=\"waves-effect waves-block waves-light notification-button\" href=\"javascript:void(0);\" data-target=\"notifications-dropdown\"><i class=\"material-icons\">notifications_none<small class=\"notification-badge orange accent-3\">" + noti.Where(x => x.Status == 1).ToList().Count + "</small></i></a></li>";
                    //result += "<li><a class=\"waves-effect waves-block waves-light profile-button\" href=\"javascript:void(0);\" data-target=\"profile-dropdown\"><span class=\"avatar-status avatar-online\"><img src=\"" + uImage + "\" alt=\"avatar\"><i></i></span></a></li>";
                    //result += "|";
