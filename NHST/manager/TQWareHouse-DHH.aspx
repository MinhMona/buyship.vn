<%@ Page Language="C#" Title="Kiểm kho JP - Đơn hàng hộ" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="TQWareHouse-DHH.aspx.cs" Inherits="NHST.manager.TQWareHouse_DHH" %>
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Kiểm hàng Nhật Bản</h4>
                </div>
            </div>
                                            ...
                                            if (data.OrderTypeInt != 2) {
                                              ...
                                              <%--  var selectedbigpack = parseFloat($("#<%=ddlBigpackage.ClientID%> option:selected").val());--%>
                                                ...
                                                if (check == false) {
                                                    ...
                                                    html += "<td><span>" + data.BarCode + "</span></td>";
                                                    //html += "<td class=\"\">";
                                                    //html += "<p><span class=\"lb\">kho JP: " + data.KhoTQ + "</span></p>";
                                        ...
                                        if (data.OrderTypeInt != 2) {
                                            ...
                                            for (var i = 0; i < listSmallpackage.length; i++) {
                                                ...
                                                if (data.OrderTypeInt != 1) {
                                                    ...
                                                    alert('Kiện này thuộc đơn hàng mua hộ, vui lòng sang trang kiểm kho JP - đơn hàng hộ.');
                                                }
                                            }
                                        }
                                    }
