<%@ Page Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="ReportManagerDealer.aspx.cs" Inherits="NHST.manager.ReportManagerDealer" %>
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Thống kê doanh thu cho đặt hàng</h4>
                ...
                <div class="list-table card-panel">
                    ...
                    <div class="responsive-tb mt-2">
                        ...
                        <table class="table bordered highlight  ">
                            <thead>
                                <tr>
                                    <th style="min-width: 100px;">Đặt hàng</th>
