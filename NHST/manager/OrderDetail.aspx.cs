    ...
    public partial class OrderDetail : System.Web.UI.Page
    {
        ...
        public void UpdatePrice()
        {
            ...
            if (obj_user != null)
            {
                ...
                var MainOrderID = Convert.ToInt32(Request.QueryString["id"]);
                if (MainOrderID > 0)
                {
        ...
        public void LoadDDL()
        {
            ...
            ddlKhoTQ.Items.Insert(0, "Chọn nhân viên kho JP");
                ...
                if (o != null)
                {
                    ...
                    if (obj_user != null)
                    {
                        ...
                        if (RoleID == 7)
                        {
                            ...
                            ddlStatus.Items.Add(new ListItem("Đã về kho JP", "6"));
                        ...
                        if (khotq != null)
                        {
                            ltr_OrderFee_UserInfo2.Text += "    <dt style=\"width: 200px;\">Nhân viên kho JP:</dt>";
                        ...
                        rFeeWarehouse.Text = string.Format("{0:N0}", feeeinwarehouse);
                        ...
                        double fscnreal = 0;
                        if (!string.IsNullOrEmpty(o.FeeShipCNReal))
                        {
                        ...
                        double alltotal = totalFee + Convert.ToDouble(o.PriceVND) + Convert.ToDouble(o.FeeShipCN) + Convert.ToDouble(o.FeeBuyPro) + Convert.ToDouble(o.FeeShipCNToVN)
                            + Convert.ToDouble(o.FeeWeight) + feeeinwarehouse + TotalFeeSupport;
                        ...
                        if (smallpackages.Count > 0)
                        {
                            foreach (var s in smallpackages)
                            {
                                ...
                                if (status == 1)
                                    ltrMavandon.Text += "<td>Chưa về kho JP</td>";
                                else if (status == 2)
                                    ltrMavandon.Text += "<td>Đã về kho JP</td>";
                                else if (status == 3)
                                ...
                                if (status == 1)
                                    spsList.Append("            <option value=\"1\" selected>Chưa về kho JP</option>");
                                else
                                    spsList.Append("            <option value=\"1\">Chưa về kho JP</option>");
                                if (status == 2)
                                    spsList.Append("            <option value=\"2\" selected>Đã về kho JP</option>");
                                else
                                    spsList.Append("            <option value=\"2\">Đã về kho JP</option>");
                                if (status == 3)
        ...
        protected void btnCurrency_Click(object sender, EventArgs e)
        {
            ...
            if (obj_user != null)
            {
                if (obj_user.RoleID == 0 || obj_user.RoleID == 2)
                {
                                ...
                                if (listorder != null)
                                {
                                    if (listorder.Count > 0)
                                    {
                                        ...
                                        foreach (var item in listorder)
                                        {
                                            ...
                                            pricevnd += oprice;
                                            OrderController.UpdateFeeCurrentCNYVN(item.ID, Currency.ToString());
                                        }
                                        pricevnd = Math.Round(pricevnd, 0);
                                        pricecyn = Math.Round(pricecyn, 2);
                                        ...
                                        servicefee = Convert.ToDouble(UserLevelController.GetByID(usercreate.LevelID.ToString().ToInt()).FeeBuyPro.ToString());
                    ...
                    PJUtils.ShowMessageBoxSwAlert("Bạn không có quyền thực hiện chức năng này. Vui lòng liên hệ ADMIN.", "i", true, Page);
            }
        }
            ...
            if (obj_user != null)
            {
                ...
                if (id > 0)
                {
                    ...
                    if (o != null)
                    {
                        ...
                        else if (pCNShipFeeNDTReal.Text.ToString() == "" || pCNShipFeeNDTReal.Text.ToString() == "NaN")
                        {
                            PJUtils.ShowMessageBoxSwAlert("Vui lòng kiểm tra lại phí ship Nhật Bản thật", "e", false, Page);
                        }
                        else if (pCNShipFeeReal.Text.ToString() == "" || pCNShipFeeReal.Text.ToString() == "NaN")
                        {
                            PJUtils.ShowMessageBoxSwAlert("Vui lòng kiểm tra lại phí ship Nhật Bản thật", "e", false, Page);
                        }
                        else if (pCNShipFee.Text.ToString() == "" || pCNShipFee.Text.ToString() == "NaN")
                        {
                            PJUtils.ShowMessageBoxSwAlert("Vui lòng kiểm tra lại phí ship Nhật Bản", "e", false, Page);
                        }
                        else if (pCNShipFeeNDT.Text.ToString() == "" || pCNShipFeeNDT.Text.ToString() == "NaN")
                        {
                            PJUtils.ShowMessageBoxSwAlert("Vui lòng kiểm tra lại phí ship Nhật Bản", "e", false, Page);
                        }
                        else
                        {
                            ...
                            if (status == 1)
                            {
                                ...
                                if (Deposit > 0)
                                {
                                    ...
                                    if (user_order != null)
                                    {
                                        ...
                                        PayOrderHistoryController.Insert(o.ID, obj_user.ID, 3, Deposit, 2, currentDate, obj_user.Username);
                            ...
                            else
                            {
                                ...
                                //Cân nặng và giá trên view
                                double totalweightInView = Convert.ToDouble(pWeightNDT.Text);
                                double totalPriceWeightInView = Convert.ToDouble(pWeight.Text);
                                double pricePerWeightInView = Math.Round(totalPriceWeightInView / totalweightInView, 0);
                                if(totalweightInView != totalweight )
                                    totalweight = totalweightInView;
                                if (totalPriceWeightInView != returnprice)
                                    returnprice = totalPriceWeightInView;
                                if (pricePerWeight != pricePerWeightInView)
                                    pricePerWeight = pricePerWeightInView;
                                ...
                                if (string.IsNullOrEmpty(CurrentOrderWeight1))
                                {
                                    if (CurrentOrderWeight1 != OrderWeight1)
                                    {
                                        ...
                                        //try
                                        //{
                                        //    PJUtils.SendMailGmail_new( AccountInfoController.GetByUserID(Convert.ToInt32(o.UID)).Email,
                                ...
                                if (OCurrent_FeeShipCN != FeeShipCN)
                                {
                                    ...
                                    //catch { }
                                    HistoryOrderChangeController.Insert(o.ID, obj_user.ID, obj_user.Username, obj_user.Username +
                                            " đã đổi tiền phí ship Nhật Bản của đơn hàng ID là: " + o.ID + ", từ " + string.Format("{0:N0}", OCurrent_FeeShipCN) + " sang "
                                ...
                                if (OCurrent_FeeWeight != FeeWeight)
                                {
                                    ...
                                    //catch { }
                                    HistoryOrderChangeController.Insert(o.ID, obj_user.ID, obj_user.Username, obj_user.Username +
                                            " đã đổi tiền phí JP-VN của đơn hàng ID là: " + o.ID + ", từ: " + string.Format("{0:N0}", OCurrent_FeeWeight) + ", sang: "
                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            PJUtils.SendMailGmail_new(
                                                accmuahan.Email,
                                                "Thông báo tại BUYSHIP.", "Đơn hàng " + o.ID
                                                + " đã được mua hàng.", "");
                                        }
                                        catch { }
                                    }
                            ...
                            string ghichuNV = "";
                            ghichuNV = ltrNV.Text;
                            MainOrderController.UpdateNoteLocal(o.ID, ghichuNV);
