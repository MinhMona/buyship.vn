        ...
        <div class="row">
            ...
            <div class="col s12">
                <div class="card-panel">
                        ...
                        <div class="col s12 report-list">
                            <div class="ad-table-report responsive-tb">
                                <table class="table tb-border  highlight striped   ">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Tổng tiền ship Nhật Bản</td>
                                            <td class="no-wrap">
                                        ...
                                        <tr>
                                            <td>Tổng tiền hàng trên website</td>
                                            <td class="no-wrap" colspan="3">
                                                <div style="justify-content: space-between">
                                                    <span class=" font-weight-400">
                    ...
                    <div class="row section mt-2" style="display: none;">
                                ...
                                <telerik:RadGrid runat="server" ID="gr" OnNeedDataSource="r_NeedDataSource" AutoGenerateColumns="False"
                                    ...
                                    <MasterTableView CssClass="table highlight  tb-border ad-rp-checkout" DataKeyNames="OrderID">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="DatHang" HeaderText="NV mua hàng" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="PriceVND" HeaderText="Tiền hàng trên web" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ShipCN" HeaderText="Phí ship nội địa Nhật" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="BuyPro" HeaderText="Phí dịch vụ" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="FeeWeight" HeaderText="Phí vận chuyển" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ShipHome" HeaderText="Phí giao hàng tận nhà" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="CheckProduct" HeaderText="Phí kiểm kê" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Package" HeaderText="Phí đóng gói" HeaderStyle-CssClass="no-wrap" HeaderStyle-Width="5%">
                                            </telerik:GridBoundColumn>
