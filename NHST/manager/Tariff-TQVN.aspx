...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">CẤU HÌNH PHÍ VẬN CHUYỂN QUỐC TẾ</h4>
                </div>
            </div>
    ...
    <div id="modalEditFee" class="modal modal-fixed-footer">
        <div class="modal-hd">
            ...
            <h4 class="no-margin center-align">CẤU HÌNH PHÍ VẬN CHUYỂN NHẬT - VIỆT</h4>
        </div>
        <div class="modal-bd">
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    <asp:ListBox runat="server" name="method" ID="ddlShipping">
                        <asp:ListItem Value="1">Đi Thường</asp:ListItem>
                        <asp:ListItem Value="2">Đi Nhanh</asp:ListItem>
                    </asp:ListBox>
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (data != null) {
                        ...
                        $('#<%=ddlShipping.ClientID%>').val(data.ShippingTypeToWareHouseID);
