        ...
        <div class="row">
            ...
            <div class="list-staff col s12 section">
                <div class="list-table card-panel">
                    <div class="filter">
                        <div class="search-name input-field no-margin" style="display:flex">
                         ...
                         <div class="search-name input-field no-margin" style="display:flex">
                              <p style="margin-right: 10px; width: 77px;">Kho JP: </p>
                            <asp:DropDownList ID="ddlKhoTQ" runat="server" CssClass="select2"
                                DataValueField="ID" DataTextField="WareHouseName">
                            </asp:DropDownList>
                        </div>
                         <div class="search-name input-field no-margin" style="display:flex">
                              <p style="margin-right: 10px; width: 77px;">Kho VN: </p>
                            <asp:DropDownList ID="ddlKhoVN" runat="server" CssClass="select2"
                                DataValueField="ID" DataTextField="WareHouseName">
                            </asp:DropDownList>
                        </div>
                          <div class="search-name input-field no-margin" style="display:flex">
                              <p style="margin-right: 10px; width: 77px;">PTVC: </p>
                            <asp:DropDownList ID="ddlPTVC" runat="server" CssClass="select2"
    ...
    <script type="text/javascript">
                                                ...
                                                if (data.OrderTypeInt != 2) {
                                                    ...
                                                    if (isExist == false) {
                                                        ...
                                                        if (check == false) {
                                                            ...
                                                            html += "<td class=\"\">";
                                                            html += "<p class=\"operator\"><span class=\"lb\">YÊN:</span><input class=\"packageadditionfeeCYN\" oninput=\"getPriceFee('packageadditionfeeCYN',$(this),'cyn')\" type=\"number\" value=\"" + data.CuocvattuCYN + "\"></p>";
                                                            ...
                                                            html += "<td class=\"\">";
                                                            html += "<p class=\"operator\"><span class=\"lb\">YÊN:</span><input class=\"packageSensorCYN\" oninput=\"getPriceFee('packageSensorCYN',$(this),'cyn')\" type=\"number\" value=\"" + data.HangDBCYN + "\"></p>";
                                                    ...
                                                    if (check == false) {
                                                        ...
                                                        if (status < 3) {
                                                            if (status == 0) {
                                                                ...
                                                                html += "<option value=\"2\" selected>Đã về kho JP</option>";
                                                            ...
                                                            if (status == 0) {
                                                                ...
                                                                html += "<option value=\"1\" selected>Mới đặt - chưa về kho JP</option>";
                                                            }
                                                            else if (status == 2) {
                                                                html += "<option value=\"2\" selected>Đã về kho JP</option>";
                                                            }
        ...
        function updateWeight(barcode, obj, packageID) {
            ...
            $.ajax({
                ...
                + "',BigPackageID:'0',packageID:'" + packageID + "',dai:'" + dai + "',rong:'" + rong + "',Username:'" + username + "',KhoTQ:'" + khoTQ + "',KhoVN:'" + khoVN + "',PTVC:'" + ptvc
