<%@ Page Title="Chi tiết đơn hàng" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="OrderDetailUpdateIncome.aspx.cs" Inherits="NHST.manager.OrderDetailUpdateIncome" %>
            ...
            <div class="order-detail-wrap col s12 section">
                <div class="row">
                    ...
                    <div class="col s12 m12 l8">
                        <div class="card-panel">
                            <div id="order-note" class="section scrollspy order-note">
                                <div class="row">
                                    <div class="col s12 m12">
                                        <div class="title-header bg-dark-gradient">
                                            <h6 class="white-text ">Ghi chú nội bộ</h6>
                                        </div>
                                        <div class="input-field col s12 m12">
                                            <asp:TextBox runat="server" ID="ltrNV" type="text" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <%--<div class="col s12 m6">
                                        <div class="title-header bg-dark-gradient">
                                            <h6 class="white-text ">Ghi chú khách hàng</h6>
                                        </div>
                                        <div class="input-field col s12 m12">
                                            <asp:TextBox runat="server" ID="ltrKH" type="text" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>--%>
                                </div>
                            </div>
                            ...
                            <div id="fee-order" class="section scrollspy fee-order">
                                ...
                                <div class="child-fee">
                                    ...
                                    <div class="content-panel">
                                        ...
                                        <div class="order-row">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    ...
                                                    <asp:Panel ID="pnCurrency" runat="server">
                                                        <div class="input-field col s12 m6">
                                                            <a href="javascript:;" class="btn btnCurrency" onclick="UpdateCurrency()">Cập nhật tỷ giá</a>
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phí ship Nhật Bản</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12 m6">
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phí ship Nhật Bản thật</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12 m6">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" ID="rFeeWarehouse" placeholder="0" Enabled="false" type="text" value=""></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="responsive-tb">
                                            <table class="table   highlight">
                                                <tr>
                                                    ...
                                                    <th class="price">Giá sản phẩm Yên</th>
                    ...
                    html += `<td>
                              <div class="input-field">
                                 <select class="transactionCodeStatus">
                                    <option value="1">Chưa về kho JP</option>
                                    <option value="2">Đã về kho JP</option>
