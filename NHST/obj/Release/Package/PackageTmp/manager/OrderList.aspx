...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="top-table-filter">
                                <div class="sort-tb-wrap">
                                    ...
                                    <div class="filter-link">
                                        <a href="javascript:;" class="btn" id="btnExport" style="background-color:green">Xuất thống kê</a>
                                ...
                                <div class="filter-wrap">
                                    ...
                                    <asp:ListItem Value="4">Đã duyệt đơn</asp:ListItem>--%>
                                                ...
                                                <asp:ListItem Value="6">Đã về kho JP</asp:ListItem>
                ...
                <div class="list-table card-panel">
                    <div class="responsive-tb">
                        ...
                        <div class="pane-shadow filter-form" id="filter-form1" style="display: block">
                            ...
                            <asp:Button ID="bttnAll" runat="server" UseSubmitBehavior="false" CssClass="order-status btn-1" OnClick="btnAll_Click" />
                            <asp:Button ID="btn0" runat="server" UseSubmitBehavior="false" CssClass="order-status btn0" OnClick="btn0_Click" />
                            <asp:Button ID="btn2" runat="server" UseSubmitBehavior="false" CssClass="order-status btn2" OnClick="btn2_Click" />
                            <%--  <asp:Button ID="btn3" runat="server" CssClass="order-status btn3" OnClick="btn3_Click" />--%>
                            <%--<asp:Button ID="btn4" runat="server" CssClass="order-status btn4" OnClick="btn4_Click" />--%>
                            <asp:Button ID="btn5" runat="server" UseSubmitBehavior="false" CssClass="order-status btn5" OnClick="btn5_Click" />
                            <asp:Button ID="btn6" runat="server" UseSubmitBehavior="false" CssClass="order-status btn6" OnClick="btn6_Click" />
                            <asp:Button ID="btn7" runat="server" UseSubmitBehavior="false" CssClass="order-status btn7" OnClick="btn7_Click" />
                            <%--  <asp:Button ID="btn8" runat="server" CssClass="order-status btn8" OnClick="btn8_Click" />--%>
                            <asp:Button ID="btn9" runat="server" UseSubmitBehavior="false" CssClass="order-status btn9" OnClick="btn9_Click" />
                            <asp:Button ID="btn10" runat="server" UseSubmitBehavior="false" CssClass="order-status btn10" OnClick="btn10_Click" />
                            <%--<asp:Button ID="btn11" runat="server" CssClass="order-status btn11" OnClick="btn11_Click" />--%>
                            <asp:Button ID="btn1" runat="server" UseSubmitBehavior="false" CssClass="order-status btn1" OnClick="btn1_Click" />
                            <%--   </div>--%>
                        </div>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", setTimeout(loadImg, 5000));
        function loadImg() {
            $.ajax({
                type: "POST",
                url: "/manager/orderlist.aspx/GetImage",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    var data = msg.d;
                    var imageList = data.split('|');
                    var elementList = $(".imgOrder");
                    $.each(elementList, function (i, element) {
                        element.insertAdjacentHTML('beforeend', imageList[i]);
                    });
                }
            });
        }
