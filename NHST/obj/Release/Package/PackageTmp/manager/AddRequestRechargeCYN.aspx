<%@ Page Title="Nạp tiền yên" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="AddRequestRechargeCYN.aspx.cs" Inherits="NHST.manager.AddRequestRechargeCYN" %>
                        ...
                        <div class="row pb-2 border-bottom-1 ">
                            <div class="input-field col s12">
                             ...
                             <div class="input-field col s12">
                                ...
                                <label for="rp_walletCNY">Ví yên (yên)</label>
                            </div>
                            <div class="input-field col s12">
