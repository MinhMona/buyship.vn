<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportOrderVNStore.aspx.cs" MasterPageFile="~/manager/adminMasterNew.Master" Inherits="NHST.manager.ReportOrderVNStore" %>
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Thống kê đơn hàng tại kho VN</h4>
                                ...
                                <div class="cot-p">
                                 ...
                                 <div class="cot-p">
                                    <div class="cot-ngang">
                                        ...
                                        <div class="price">
                                            <asp:Literal runat="server" ID="ltrTongtienconno"></asp:Literal>
                                        </div>
                                    </div>
                                    <div class="cot-ngang">
                                        <div class="text-bold">
                                        ...
                                        <div class="price">
                                            <asp:Literal runat="server" ID="ltrTongtiendatra"></asp:Literal>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="responsive-tb mt-2">
                       <%-- <a href="javascript:;" class="btn" style="margin-bottom: 10px" id="btnExport">Xuất thống kê</a>--%>
                        <table class="table bordered highlight  ">
                            <thead>
                                <tr>
                                    <th style="min-width: 100px;">NV Sale</th>
                                    ...
                                    <th style="min-width: 100px;">Phí cân nặng</th>
                                    <th style="min-width: 100px;">Tiền đã trả</th>
                                    <th style="min-width: 100px;">Tiền còn nợ</th>
