...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button Style="display: none" UseSubmitBehavior="false" ID="btnSearchPhone" runat="server" OnClick="btnSearchPhone_Click" />
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    ...
                    <div class="right-action">
                        <a href="javascript:;" class="btn btnExcel" style="background-color: green;">Xuất Excel</a>
            ...
            <div class="list-staff col s12 section">
                <div class="list-table card-panel">
                    <div class="filter">
                        <div class="search-name input-field col s12 l4">
                        ...
                        <div class="search-name input-field col s12 l4">
                            <asp:TextBox ID="search_phone" placeholder="" name="txtSearchPhone" type="text" onkeypress="myFunction()" runat="server" />
                            <label for="search_name"><span>Số điện thoại</span></label>
                            <span class="material-icons searchPhone-action">search</span>
                        </div>
                        <div class="search-name input-field col s12 l4">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control select">
                        ...
                        <asp:ListItem Value="4">Nhân viên kho JP</asp:ListItem>
    ...
    <script>
        ...
        $('.searchPhone-action').click(function () {
            console.log('dkm ngon');
            console.log($('#<%=search_phone.ClientID%>').val());
            $('#<%=btnSearchPhone.ClientID%>').click();
        })
        function Save() {
