        ...
        public void loadData()
        {
            try
            {
                ...
                if (pt != null)
                {
                    ...
                    string weblink = "https://FALOSHIP.COM";
                    ...
                    if (!string.IsNullOrEmpty(pt.ogimage))
                        ...
                        objMetaFacebook.Content = weblink + "/App_Themes/TrungVietOrder/images/logo.png";
                    ...
                    if (!string.IsNullOrEmpty(pt.metatitle))
                        this.Title = "FALOSHIP.COM - " + pt.metatitle;
                    else
                        this.Title = "FALOSHIP.COM - " + pt.PageTypeName;
