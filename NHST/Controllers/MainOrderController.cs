...
namespace NHST.Controllers
{
    public class MainOrderController
    {
        ...
        public static string Insert(int UID, string ShopID, string ShopName, string Site, bool IsForward, string IsForwardPrice, bool IsFastDelivery, string IsFastDeliveryPrice, bool IsCheckProduct,
            ...
            int SalerID, int DathangID, DateTime CreatedDate, int CreatedBy, string AmountDeposit, int OrderType, string FeeBuyProUser)
        {
        ...
        /* public static List<tbl_MainOder> GetAllByOrderType(int OrderType)
         {
             using (var dbe = new NHSTEntities())
             {
                 ...
                 lo = dbe.tbl_MainOder.Where(o => o.OrderType == OrderType).ToList();
                 return lo;
             }
         }*/
        public static int[] GetAllByOrderType(int OrderType)
        {
            SqlParameter[] parameters = new SqlParameter[1];
            parameters[0] = new SqlParameter("@stype", OrderType);
            var result = new int[11];
            var reader = SqlHelper.ExecuteDataTable("GetAllByOrderType", parameters).CreateDataReader();
            while (reader.Read())
            {
                int status = Convert.ToInt32(reader["status"].ToString());
                result[status] = Convert.ToInt32(reader["Quantity"].ToString());
            }
            return result;
        }
        ...
        public static string UpdateNoteLocal(int ID, string Note)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_MainOder.Where(o => o.ID == ID).FirstOrDefault();
        ...
        public static string UpdateTongTien(int ID, string TotalPriceVND)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_MainOder.Where(o => o.ID == ID).FirstOrDefault();
        ...
        #region GetAll
        public static List<IncomSaler> GetFromDateToDate_IncomDealer_total(string fd, string td, string Username, string Saler, int pageIndex, int pageSize, string st)
        {
            ...
            sql += ", Sum((convert(float,mo.PriceVND) +(convert(float,mo.FeeShipCN)))-(convert(float,mo.TotalPriceReal)) -(convert(float,mo.FeeShipCNReal))) as tienmacca ";
        ...
        public static List<IncomSaler> GetFromDateToDate_IncomDealer_Thang_total(string fd, string td, string Username, string Saler, string st)
        {
            var list = new List<IncomSaler>();
        ...
        public static List<tbl_MainOder> GetFromDateToDate(DateTime from, DateTime to)
        {
            using (var dbe = new NHSTEntities())
            {
                ...
                var alllist = dbe.tbl_MainOder.Where(x => x.Status != 1).OrderByDescending(t => t.CreatedDate).ThenBy(t => t.Status).ToList();
                if (alllist.Count > 0)
                {
        ...
        public static List<tbl_MainOder> GetFromDateToDateKhoVN(DateTime from, DateTime to)
        {
            using (var dbe = new NHSTEntities())
            {
                List<tbl_MainOder> lo = new List<tbl_MainOder>();
                ...
                if (alllist.Count > 0)
                {
                    if (!string.IsNullOrEmpty(from.ToString()) && !string.IsNullOrEmpty(to.ToString()))
                    {
                        lo = alllist.Where(t => t.DateVN >= from && t.DateVN <= to).OrderByDescending(t => t.CreatedDate).ThenBy(t => t.Status).ToList();
                    }
                    else if (!string.IsNullOrEmpty(from.ToString()) && string.IsNullOrEmpty(to.ToString()))
                    {
                        lo = alllist.Where(t => t.DateVN >= from).OrderByDescending(t => t.CreatedDate).ThenBy(t => t.Status).ToList();
                    }
                    else if (string.IsNullOrEmpty(from.ToString()) && !string.IsNullOrEmpty(to.ToString()))
                    {
                        lo = alllist.Where(t => t.DateVN <= to).OrderByDescending(t => t.CreatedDate).ThenBy(t => t.Status).ToList();
                    }
                    else
                    {
                        lo = alllist;
        ...
        public static List<tbl_MainOder> GetAllByUIDStatus(int UID, int Status)
        {
            using (var dbe = new NHSTEntities())
            {
                List<tbl_MainOder> lo = new List<tbl_MainOder>();
        ...
        public static List<OrderGetSQL> GetByUserIDInSQLHelper_WithPaging(int userID, int page, int maxrows)
        {
            ...
            sql += "WHEN 6 THEN N'<span class=\"bg-green\">Đã về kho JP</span>' ";
        ...
        public static List<tbl_MainOder> GetAllByUIDAndOrderType(int UID, int OrderType)
        {
            ...
            {
                List<tbl_MainOder> lo = new List<tbl_MainOder>();
                lo = dbe.tbl_MainOder.Where(o => o.UID == UID && o.OrderType == OrderType && o.IsHidden != true && o.Status != 1).ToList();
                return lo;
            }
        }
        ...
        public static List<mainorder> GetAllByUIDNotHidden_SqlHelperNew(int UID, string search, int typesearch, int status, string fd, string td, int OrderType, int page)
        {
            ...
            sql += " where UID = " + UID + " AND mo.OrderType = " + OrderType + " AND mo.Status != 1 ";
                    ...
                    if (typesearch == 2)
                    {
                        ...
                        if (orders.Count > 0)
                        {
                            ...
                            if (reader["DateTQ"] != DBNull.Value)
                                entity.DateTQ = "<p class=\"s-txt no-wrap\">Đã về kho JP: " + string.Format("{0:HH:mm}", Convert.ToDateTime(reader["DateTQ"].ToString())) + " - " + string.Format("{0:dd/MM/yyyy}", Convert.ToDateTime(reader["DateTQ"].ToString())) + " </p>";
        ...
        public static List<MainOrderReport> GetBuyProBySQLNotPage(string fd, string td)
        {
            var sql = @"select * ";
            sql += "from dbo.tbl_MainOder ";
            sql += "Where Status > = 5 ";
            ...
            var reader = (IDataReader)SqlHelper.ExecuteDataReader(sql);
            List<MainOrderReport> list = new List<MainOrderReport>();
            while (reader.Read())
            {
                var entity = new MainOrderReport();
                ...
                if (reader["FeeShipCNReal"] != DBNull.Value)
                    entity.FeeShipCNReal = reader["FeeShipCNReal"].ToString();
                ...
                entity.Username = "";
                var acc = AccountController.GetByID(Convert.ToInt32(reader["UID"].ToString().ToInt(0)));
                if (acc != null)
                    entity.Username = acc.Username;
                ...
                entity.DateVN = "";
                if (reader["DateVN"] != DBNull.Value)
                    entity.DateVN = Convert.ToDateTime(reader["DateVN"].ToString()).ToString("dd/MM/yyyy HH:mm");

                entity.CompleteDate = "";
                if (reader["CompleteDate"] != DBNull.Value)
                    entity.CompleteDate = Convert.ToDateTime(reader["CompleteDate"].ToString()).ToString("dd/MM/yyyy HH:mm");
        ...
        public static List<MainOrderReport> GetBuyProBySQL(string fd, string td, int pageIndex, int pageSize)
        {
            var sql = @"select * ";
            sql += "from dbo.tbl_MainOder ";
            sql += "Where Status > = 5 ";
        ...
        public static List<ReportOrderINVNStore_Result> GetOrderINVNStoreList(int type, string searchtext, string fd, string td, string status, int pageSize, int pageIndex, int sort)
        {
            using (var db = new NHSTEntities())
            {
                return db.ReportOrderINVNStore(type, searchtext, fd, td, status, pageSize, pageIndex, sort).ToList();
            }
        }
        public static List<ReportOrderINVNStoreExcel_Result> GetOrderINVNStoreListExcel(int type, string searchtext, string fd, string td, string status, int sort)
        {
            using (var db = new NHSTEntities())
            {
                return db.ReportOrderINVNStoreExcel(type, searchtext, fd, td, status, sort).ToList();
            }
        }

        public static ReportOrderINVNStoreTotal_Result GetOrderINVNStoreListTotal(int type, string searchtext, string fd, string td, string status)
        {
            using (var db = new NHSTEntities())
            {
                return db.ReportOrderINVNStoreTotal(type, searchtext, fd, td, status).FirstOrDefault();
            }
        }

        public static List<ReportOrderLate_Result> GetOrderLateList(int type, string searchtext, string fd, string td, string status, int pageSize, int pageIndex, int sort)
        {
            using (var db = new NHSTEntities())
            {
                return db.ReportOrderLate(type, searchtext, fd, td, status, pageSize, pageIndex, sort).ToList();
            }
        }

        public static string UpdateStaffNote(int ID, string note)
        {
            using (var dbe = new NHSTEntities())
            {
                var or = dbe.tbl_MainOder.Where(o => o.ID == ID).FirstOrDefault();
        ...
        public static List<OrderGetSQL> GetListForOrderListOfProcedure(int RoleID, int StaffID, int orderType, string searchtext, int Type, string fd, string td, string priceFrom, string priceTo, string st, bool isNotCode, int pageIndex, int pageSize, string mvd, string mdh, int sort)
        {
            Debug.WriteLine("a" + DateTime.Now);
            var list = new List<OrderGetSQL>();
            SqlParameter[] parameters = new SqlParameter[16];
            parameters[0] = new SqlParameter("@RoleID", RoleID);
            parameters[1] = new SqlParameter("@StaffID", StaffID);
            parameters[2] = new SqlParameter("@orderType", orderType);
            parameters[3] = new SqlParameter("@searchtext", searchtext);
            parameters[4] = new SqlParameter("@Type", Type);
            if (!string.IsNullOrEmpty(fd))
            {
                var df = DateTime.ParseExact(fd, "dd/MM/yyyy HH:mm", null);
                parameters[5] = new SqlParameter("@fd", df);
            }
            else
            {
                parameters[5] = new SqlParameter("@fd", null);
            }
            if (!string.IsNullOrEmpty(td))
            {
                var dt = DateTime.ParseExact(td, "dd/MM/yyyy HH:mm", null);
                parameters[6] = new SqlParameter("@td", dt);
            }
            else
            {
                parameters[6] = new SqlParameter("@td", null);
            }

            if (!string.IsNullOrEmpty(priceFrom))
            {
                parameters[7] = new SqlParameter("@priceFrom", priceFrom);
            }
            else
            {
                parameters[7] = new SqlParameter("@priceFrom", null);
            }

            if (!string.IsNullOrEmpty(priceTo))
            {
                parameters[8] = new SqlParameter("@priceTo", priceTo);
            }
            else
            {
                parameters[8] = new SqlParameter("@priceTo", null);
            }
            parameters[9] = new SqlParameter("@st", st);
            parameters[10] = new SqlParameter("@isNotCode", isNotCode);
            parameters[11] = new SqlParameter("@pageIndex", pageIndex);
            parameters[12] = new SqlParameter("@pageSize", pageSize);
            if (!string.IsNullOrEmpty(mvd))
            {
                parameters[13] = new SqlParameter("@mvd", mvd);
            }
            else
            {
                parameters[13] = new SqlParameter("@mvd", null);
            }

            if (!string.IsNullOrEmpty(mdh))
            {
                parameters[14] = new SqlParameter("@mdh", mdh);
            }
            else
            {
                parameters[14] = new SqlParameter("@mdh", null);
            }
            parameters[15] = new SqlParameter("@Sort", sort);
            var reader = SqlHelper.ExecuteDataTable("GetOrderList", parameters).CreateDataReader();
            while (reader.Read())
            {
                int Status = 0;
                int MainOrderID = reader["ID"].ToString().ToInt(0);
                ...
                if (reader["Username"] != DBNull.Value)
                    entity.Uname = reader["Username"].ToString();
                ...
                if (reader["TotalRow"] != DBNull.Value)
                {
                    entity.TotalRow = Convert.ToInt32(reader["TotalRow"].ToString());
                }
                ...
                if (reader["MainOrderCode"] != DBNull.Value)
                    entity.listMainOrderCode = reader["MainOrderCode"].ToString().Split('|').ToList();
                ...
                /*if (reader["hasSmallpackage"] != DBNull.Value)
                    entity.hasSmallpackage = reader["hasSmallpackage"].ToString();*/
                if (entity.IsDoneSmallPackage)
                {
                    entity.hasSmallpackage = "<span class=\"badge blue darken-2 white-text border-radius-2\">Đã đủ MVĐ</span>";
                }
                else if (entity.QuantityMVD > 0)
                {
                    entity.hasSmallpackage = "<span class=\"badge yellow darken-2 white-text border-radius-2\">Đã nhập</span>";
                }
                else
                {
                    entity.hasSmallpackage = "<span class=\"badge red darken-2 white-text border-radius-2\">Chưa nhập MVĐ</span>";
                }
                ...
                {
                    if (reader["DateTQ"] != DBNull.Value)
                        entity.DateTQ = "<p class=\"s-txt no-wrap red-text\"><span class=\"mg\">Đã về kho JP:</span><span> " + string.Format("{0:HH:mm}", Convert.ToDateTime(reader["DateTQ"].ToString())) + " - " + string.Format("{0:dd/MM/yyyy}", Convert.ToDateTime(reader["DateTQ"].ToString())) + "</span> </p>";
                }
                else
                {
                    if (reader["DateTQ"] != DBNull.Value)
                        entity.DateTQ = "<p class=\"s-txt no-wrap\"><span class=\"mg\">Đã về kho JP:</span><span> " + string.Format("{0:HH:mm}", Convert.ToDateTime(reader["DateTQ"].ToString())) + " - " + string.Format("{0:dd/MM/yyyy}", Convert.ToDateTime(reader["DateTQ"].ToString())) + "</span> </p>";
                }
            ...
            reader.Close();
            Debug.WriteLine("b" + DateTime.Now);
            return list;
        }
        ...
        {
            var list = new List<OrderGetSQL>();
            var sql = @"SELECT mo.ID, mo.TotalPriceVND, mo.CurrentCNYVN, mo.DathangID, mo.SalerID ,mo.IsDoneSmallPackage,sz.MaDonHangString,se.MaVanDon,sw.MaDonHang,sp.TenSanPham, mo.Deposit, mo.CreatedDate, mo.DepostiDate, mo.DateBuy, mo.DateTQ, mo.DateVN,mo.PayDate,mo.CompleteDate,mo.FeeWeight, mo.Status, mo.OrderType, mo.IsCheckNotiPrice, mo.BarCode, mo.QuantityMVD, mo.QuantityMDH, mo.MainOrderCode, mo.PriceVND, ";
            ...
            sql += "WHEN 6 THEN N'<span class=\"badge green darken-2 white-text border-radius-2\">Đã về kho JP</span>' ";
        ...
        public static List<IncomSaler> GetFromDateToDate_IncomSaler_Thang_total(string fd, string td, string Username, string Saler, string st)
        {
            var list = new List<IncomSaler>();
        ...
        public static List<IncomSaler> GetFromDateToDate_IncomSaler_total(string fd, string td, string Username, string Saler, int pageIndex, int pageSize, string st)
        {
            var list = new List<IncomSaler>();
        ...
        public class MainOrderReport
        {
            ...
            public string LessDeposit { get; set; }
            public string FeeBuyProPT { get; set; }
            public string FeeShipCNRealCYN { get; set; }
            public string FeeShipCNCYN { get; set; }
            public string IsCheckProductPriceCYN { get; set; }
            public string IsPackedPriceCYN { get; set; }
        }
    }
}