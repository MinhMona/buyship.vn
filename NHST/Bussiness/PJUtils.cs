...
namespace NHST.Bussiness
{
    ...
    {
        public static string ShowStatusGiaoHang(int status)
        {
            if (status == 1)
        ...
        public static string IntToRequestAdmin(int i)
        {
            if (i == 0)
                ...
                return "<span class=\"bg-green\">Đã về kho JP</span>";
            else if (i == 7)
        ...
        public static string IntToStringStatusSmallPackage(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"bg-red\">Mới đặt - chưa về kho JP</span>";
            else if (status == 2)
                return "<span class=\"bg-orange\">Đã về kho JP</span>";
            else if (status == 3)
                return "<span class=\"bg-green\">Đã về kho đích</span>";
            else
        ...
        public static string IntToStringStatusSmallPackageWithBG(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"bg-yellow\">Đã về kho JP</span>";
            else if (status == 3)
                return "<span class=\"bg-green\">Đã về kho đích</span>";
            else
                return "<span class=\"bg-blue\">Đã giao cho khách</span>";
        ...
        public static string IntToRequestAdminNew(int i)
        {
            if (i == 0)
                ...
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đã duyệt đơn</span>";
            else if (i == 5)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đã mua hàng</span>";
            else if (i == 6)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đã về kho JP</span>";
            else if (i == 7)
        ...
        public static string IntToStringStatusSmallPackageNew(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge red darken-2 white-text border-radius-2\">Mới đặt - chưa về kho JP</span>";
            else if (status == 2)
                return "<span class=\"badge orange darken-2 white-text border-radius-2\">Đã về kho JP</span>";
            else if (status == 3)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đã về kho đích</span>";
            else if (status == 4)
                return "<span class=\"badge blue darken-2 white-text border-radius-2\">Đã thanh toán</span>";
        ...
        public static string IntToStringStatusSmallPackageTextNew(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"red-text\">Mới đặt - chưa về kho JP</span>";
            else if (status == 2)
                return "<span class=\"orange-text\">Đã về kho JP</span>";
            else if (status == 3)
        ...
        public static string IntToStringStatusSmallPackageWithBGNew(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge yellow darken-2 white-text border-radius-2\">Đã về kho JP</span>";
            else if (status == 3)
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đã về kho đích</span>";
            else
        ...
        public static string IntToRequestClientNew(int i)
        {
            if (i == 0)
                ...
                return "<span class=\"badge green darken-2 left m-0\">Đã duyệt đơn</span>";
            else if (i == 5)
        ...
        public static string IntToStringStatusSmallPackage45(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"white-text badge red darken-2\">Mới đặt - chưa về kho JP</span>";
            else if (status == 2)
                return "<span class=\"white-text badge teal darken-2\">Đã về kho JP</span>";
            else if (status == 3)
        ...
        public static string IntToStringStatusSmallPackageWithBG45(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge border-radius-2 darken-2 red white-text\">Mới đặt - chưa về kho JP</span>";
            else if (status == 2)
        ...
        public static string ShowStatusPayHistoryNew(int status)
        {
            if (status == 2)
                ...
                return "<span class=\"badge red darken-2 white-text border-radius-2\">Hoàn tiền hủy đơn</span>";
            else if (status == 12)
                return "<span class=\"badge red darken-2 white-text border-radius-2\">Sản phẩm hết hàng hoặc giảm giá trả lại cọc</span>";
            else
                return "<span class=\"badge blue darken-2 white-text border-radius-2\">Thanh toán</span>";
        ...
        public static void PushNotiDesktop(int UID, string title, string link)// đẩy thông báo xuống desktop trình duyệt
        {
            ...
            if (ltoken != null)
            {
                ...
                n.title = "FALOSHIP.COM";
                n.message = title;
                n.icon = "https://FALOSHIP.COM/Uploads/NewsIMG/2-10-2020-21420-PM.png"; // đổi đường dẫn logo của khách
                n.link = link;
