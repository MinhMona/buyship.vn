                            ...
                            <div class="row">
                                <div class="input-field col s12 align-center">
                                    <span class="img logo-login">
                                        <a href="/">
                                            <img src="/App_Themes/CSSBUYSHIP/images/logo.png" alt="logo"></a></span>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <asp:DropDownList ID="ddlWarehouseFrom" runat="server"
                                        ...
                                        <asp:ListItem Value="" Selected disabled>Kho Nhật</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="input-field col s12">
                                    <i class="material-icons prefix ">dns</i>
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <asp:DropDownList ID="ddlShippingType" runat="server" CssClass="form-control"
                                        ...
                                        <asp:ListItem Value="" Selected disabled>Phương thức vận chuyển</asp:ListItem>
                                    </asp:DropDownList>
