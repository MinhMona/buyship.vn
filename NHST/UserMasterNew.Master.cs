        ...
        public void LoadNotification()
        {
            ...
            if (acc != null)
            {
                ...
                if (config != null)
                {
                    ...
                    ltrHeaderLeft.Text += "<div class=\"balance__number\"><p class=\"vnd\">" + string.Format("{0:N0}", acc.Wallet) + " đ</p></div>";
                    ltrHeaderLeft.Text += "</div>";
                    if (acc.RoleID != 1)
                        ltrHeaderLeft.Text += "<div class=\"links\"><a href=\"/manager/login\">Quản trị<i class=\"fa fa-caret-right\"></i></a></div>";                    
                    ltrHeaderLeft.Text += "<div class=\"links\"><a href=\"/danh-sach-don-hang?t=3\">Đơn hàng của bạn<i class=\"fa fa-caret-right\"></i></a></div>";
